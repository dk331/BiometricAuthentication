...
public class BiometricManagerV23 {
            ...
            fingerprintManagerCompat.authenticate(cryptoObject, 0, mCancellationSignalV23,
                    new FingerprintManagerCompat.AuthenticationCallback() {
                        ...
                        public void onAuthenticationError(int errMsgId, CharSequence errString) {
                            ...
                            updateFingerImage(R.drawable.ic_info_outline_black_24dp);
                        ...
                        public void onAuthenticationHelp(int helpMsgId, CharSequence helpString) {
                            ...
                            updateFingerImage(R.drawable.ic_fingerprint_black_24dp);
                        ...
                        public void onAuthenticationSucceeded(FingerprintManagerCompat.AuthenticationResult result) {
                            ...
                            dismissDialog();
                            updateStatus(context.getString(R.string.biometric_success));
                            updateFingerImage(R.drawable.ic_check_circle_color_24dp);
    ...
    private void updateFingerImage(int id) {
        if (biometricDialogV23 != null) {
            biometricDialogV23.updateFingerImage(id);
        }
    }
